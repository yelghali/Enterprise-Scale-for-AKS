...
**Backup & Restore of metadata + cluster configuration**
  ...
  -  Velero has a concept of *BackupStorageLocation* : defined as a bucket (in an Azure Storage Account), in which all Velero data is stored. (Ypu can define multiple StorageLocations for different backup destinations)
